...
//
//        private class Block implements Iterable<Record> {
//            private BacktrackingIterator<Record> recordIterator;
//
//            BlockRecordIterator(String tableName, Iterator<Page> block, int maxPages) {
//                if (block.hasNext()) {
//                    recordIterator = getBlockIterator(tableName, block, maxPages);
//                } else {
//                    recordIterator = null;
//                }
//
